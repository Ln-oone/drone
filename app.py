...
# 在 create_planning_map 函数中，确保起点和终点都有安全半径圆
def create_planning_map(center_gcj, points_gcj, obstacles_gcj, flight_history, 
                        planned_path, straight_blocked, flight_altitude, 
                        drone_pos, direction, safety_radius):
    # ... 现有代码 ...
